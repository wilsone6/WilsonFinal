...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($action == 'edit') {
	// Edit book
	$sql = file_get_contents('sql/updatePackages.sql');
    $params = array( 
			'package_id' => $package_id,
	...
	<div class="page">
		<form action="" method="POST">
			<div class="form-element" align="center">
				...
				<input type="text" name="package_name" class="textbox" value="<?php echo $package['package_name'] ?>" />
			</div>
			<div class="form-element" align="center">
				<label>Package Price</label>
				<input type="number" name="package_price" class="textbox" value="<?php echo $package['package_price'] ?>" />
			</div>
			<div class="form-element" align="center">
